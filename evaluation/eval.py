...
sys.path.extend([
    ...
    os.path.abspath(os.path.join(os.getcwd(), "../tools/")),
    os.path.abspath(os.path.join(os.getcwd(), "utils/")),
    os.path.abspath(os.path.join(os.getcwd(), "../utils/"))
])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--evaluation_file_path", type=str, default="/home/chinmay/test_llama/TravelPlanner_llama/validation_llama3:8b-instruct-fp16_two-stage_submission.jsonl")
